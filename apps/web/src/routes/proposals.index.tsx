...
function ProposalsPage() {
  ...
  return (
    <main
      ...
      className="relative mx-auto max-w-4xl px-4 pb-24 pt-8 sm:px-6 sm:pt-12"
    >
  ...
  return (
    ...
    >
      ...
      <p className="mx-auto mt-3 max-w-sm font-serif text-[15px] italic leading-relaxed text-muted-foreground">
        No motions have been filed yet. Be the first to enter one before the
        assembly.
      </p>
      {isConnected ? (
  ...
  return (
    <li>
      ...
      >
        ...
        <h3 className="mt-3 font-serif text-[17px] leading-snug text-foreground sm:text-[18px]">
          {title}
        </h3>
