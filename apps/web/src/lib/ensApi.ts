...
export async function fetchAvailability(label: string, signal?: AbortSignal): Promise<AvailabilityResponse> {
...
export async function fetchSubnameIdentity(address: Address, signal?: AbortSignal): Promise<SubnameIdentity | null> {
...
export async function fetchAllSubnameIdentities(signal?: AbortSignal): Promise<SubnameIdentity[]> {
